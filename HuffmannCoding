...
public class HuffmannCoding {
    ...
    public static void main(String[] args) {
        ...
        String Binformat = huffman.Binary(text);
        ...
        System.out.println("Initial Encoded String : " + Binformat);
        System.out.println("Initial Size : " + Math.ceil(Binformat.length()/8)+" Bytes");
        System.out.println("Encoded String: " + encodedString);
        System.out.println("Size After Compression : " + Math.ceil(encodedString.length()/8)+" Bytes");
